...
#include "Data/PlayerFormsAssetData.h"
...
AShapeCTemplateCharacter::AShapeCTemplateCharacter()
{
...
void AShapeCTemplateCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void AShapeCTemplateCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AShapeCTemplateCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AShapeCTemplateCharacter::Look);

		// ShapeShift
		EnhancedInputComponent->BindAction(ShapeShiftAction, ETriggerEvent::Started, this, &AShapeCTemplateCharacter::ShapeShift);
	}
	else
	{
...
void AShapeCTemplateCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AShapeCTemplateCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AShapeCTemplateCharacter::ShapeShift(const FInputActionValue& Value)
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("Valid Data Assets"));
		for (int i = 0; i < PlayerFormsDataAsset->PlayerForms.Num(); i++)
		{
...
FPlayerStats AShapeCTemplateCharacter::NewStats(TSubclassOf<AShapeCTemplateCharacter> NewForm)
{
	...
	NewPlayerStats = NewForm.GetDefaultObject()->PlayerStats;

	NewPlayerStats.Health = PlayerStats.Health * (NewPlayerStats.MaxHealth / PlayerStats.MaxHealth);
